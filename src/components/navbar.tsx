    ...
    <>
      ...
      <header className="sticky top-0 z-40 border-b border-honor-border glass">
        ...
        <div className="ml-auto flex items-center gap-2 sm:gap-4">
          ...
          <Link
            href="/search"
            className="md:hidden text-xs sm:text-sm text-honor-text hover:text-honor-textGray transition-colors px-2"
          >
            🔍
          </Link>

          {/* Admin Link - Now visible on all screens */}
          <Link
            href="/admin/login"
            className="text-xs sm:text-sm text-honor-textGray hover:text-honor-text transition-colors px-2 whitespace-nowrap"
            title="Acceso Admin"
          >
          ...
          >
            <svg
              className="w-5 h-5 sm:w-6 sm:h-6 text-honor-text group-hover:text-honor-textGray transition-colors"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
            ...
            <Badge className="absolute -top-1 -right-1 bg-honor-primary text-white font-bold text-xs">
